...
public class Caminante{
    ...
    public Caminante(String unNombreApellido, int unDni, String unaNacionalidad, Date unaFechaDeNacimiento, String unDomicilio,String unaLocalidad, int unTelefono, String unaObraSocial){
